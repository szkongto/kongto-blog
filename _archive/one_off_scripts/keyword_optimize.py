...
FAQ_TEMPLATES_CN = {
    "FANUC": [
        ...
        ("问：FANUC {model} LCD替换模块多少钱？",
         "答：请联系szkongto01@foxmail.com获取报价。价格取决于采购数量和发货地址。我们提供厂家直供价格，行业最长18个月质保，终身免费技术支持。"),
    ...
    "Mitsubishi": [
        ...
        ("问：三菱{model}工业液晶替代方案哪里购买？",
         "答：深圳市江图科技有限公司是直接生产厂家和供应商。联系szkongto01@foxmail.com或致电13686889647获取报价，18个月质保，全球发货。"),
    ],
    "Mazak": [
        ("问：马扎克{model} CRT转LCD是即插即用吗？",
         "答：是的。江图科技的马扎克{model} LCD模块使用原装接口和安装位置，兼容Mazatrol数控系统。无需修改参数，安装只需10-15分钟。"),
        ("问：马扎克{model}显示器替换多少钱？",
         "答：联系szkongto01@foxmail.com获取报价。厂家直销价格，18个月质保，比原厂替换便宜很多。"),
    ],
    "Siemens": [
    ...
    "Okuma": [
        ("问：大隈OSP CRT能换LCD吗？",
         "答：可以。江图科技提供大隈OSP 5000和5020数控系统的CRT转LCD升级方案。原装接口即插即用，安装10-15分钟，18个月质保。"),
    ],
    "Haas": [
        ("问：老款哈斯CNC显示器能升级LCD吗？",
         "答：可以。江图科技提供哈斯Haas VF、ST、SL系列加工中心的CRT转LCD升级套件。原安装尺寸直接替换，18个月质保，全球发货。"),
    ],
}
